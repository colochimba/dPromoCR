...
var AuthService = /** @class */ (function () {
    function AuthService(AFauth, Afirebase) {
        this.AFauth = AFauth;
    ...
    AuthService.prototype.login = function (email, password) {
        ...
        return new Promise(function (resolve, rejected) {
            _this.AFauth.auth.signInWithEmailAndPassword(email, password)
                ...
                if (_this.authUser.emailVerified !== true) {
    ...
    AuthService.prototype.createUserInDB = function (email) {
    ...
    AuthService.prototype.getUserInDB = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.Afirebase.database.ref('user/' + this.getCurrentUserKey()).once('value')
    ...
    AuthService.prototype.updateUserInDB = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.Afirebase.database.ref('user/' + _this.getCurrentUserKey()).set(_this.currentUser, function (error) {
                if (error) {
                    reject();
                }
                else {
    ...
    AuthService.prototype.getCurrentUserKey = function () {
    ...
    AuthService.prototype.sendVerificationMail = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authUser.sendEmailVerification()];
...
/***/ "./src/app/servicios/nav.service.ts":
/*!******************************************!*\
  !*** ./src/app/servicios/nav.service.ts ***!
  \******************************************/
...
/*!*****************************!*\
  !*** ./src/json/index.json ***!
  \*****************************/
/*! exports provided: promotions, featured, news, categories, default */
/***/ (function(module) {

module.exports = {"promotions":[{"promoName":"Promocion 1","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food1","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Comida"},{"promoName":"Promocion 2","promoID":2,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food2","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Comida"},{"promoName":"Promocion 3","promoID":3,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food3","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Tienda"},{"promoName":"Promocion 4","promoID":4,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food4","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Tienda"}],"featured":[{"promoName":"Destacada 1","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food1","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Comida"},{"promoName":"Destacada 2","promoID":2,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food2","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Comida"},{"promoName":"Destacada 3","promoID":3,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food3","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Tienda"},{"promoName":"Destacada 4","promoID":4,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?food4","promoDescription":"Aqui una leve descripcion de que se trata la promocion","promoPlace":"Cartago Centro","promoDate":"01/12/2019","promoTel":"5555-5555","promoWeb":"www.alito.com","promoCategory":"Tienda"}],"news":[{"promoName":"Noticia 1","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?news1","promoDescription":"Aqui una leve descripcion de que se trata la promocion"},{"promoName":"Noticia 2","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?news2","promoDescription":"Aqui una leve descripcion de que se trata la promocion"},{"promoName":"Noticia 3","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?news3","promoDescription":"Aqui una leve descripcion de que se trata la promocion"},{"promoName":"Noticia 4","promoID":1,"promoBusiness":"Tienda Alito","promoPhotoURL":"https://source.unsplash.com/random/?news4","promoDescription":"Aqui una leve descripcion de que se trata la promocion"}],"categories":[{"categoryName":"Todos","categoryIcon":"refresh"},{"categoryName":"Comida","categoryIcon":"restaurant"},{"categoryName":"Tienda","categoryIcon":"shirt"},{"categoryName":"Diversión","categoryIcon":"bicycle"},{"categoryName":"Salud","categoryIcon":"medkit"}]};
